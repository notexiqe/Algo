...
int main()
{
	...
	do
	{
		...
		switch (innerSwitchFlag)
		{
			case  1: 
			{
				bubble_sort(pArray, gArraySize);
				break;
			}
			case  2: 
			{
				shaker_sort(pArray, gArraySize);
				break;
			}
			case  3: 
			{
				comb_sort(pArray, gArraySize);
				break;
			}
			case  4: 
			{
				insert_sort(pArray, gArraySize);
				break;
			}
			case  5:
			{
				shell_sort(pArray, gArraySize);
				break;
			}
			case  6:
			{
			...
			case  7:
			{
				gnome_sort(pArray, gArraySize);
				break;
			}
			case  8:
			{
				select_sort(pArray, gArraySize);
				break;
			}
			case  9:
			{
				quicksort(pArray, gArraySize, 0, (gArraySize - 1));
				break;
			}
			case 10:
			{
				heap_sort(pArray, gArraySize);
				break;
			}
			default:
			{
